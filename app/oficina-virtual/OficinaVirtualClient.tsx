...
export default function OficinaVirtualClient() {
            ...
            <div className="relative z-10 container mx-auto px-6 py-32 md:py-40">
                    ...
                    <div className="group relative">
                        ...
                        <div className="relative h-full bg-navy-deep/50 backdrop-blur-md border border-white/10 rounded-3xl p-8 hover:border-blue-inst/50 transition-all duration-300 flex flex-col">
                            ...
                            <div className="space-y-4 flex-1">
                                ...
                                {/* Soporte Académico Trigger */}
                                <button
                                    onClick={() => setIsSupportModalOpen(true)}
                                    className="w-full text-left p-4 rounded-xl bg-white/5 hover:bg-white/10 border border-white/5 hover:border-white/20 transition-all group/item"
                                >
                                    <div className="flex items-center justify-between">
                                        <div className="flex items-center gap-3">
                            ...
                            <div className="mt-8 pt-6 border-t border-white/10">
                                ...
                                <a href="https://wa.me/56984534364" target="_blank" rel="noopener noreferrer">
                        ...
                        <div className="relative h-full bg-navy-deep/50 backdrop-blur-md border border-white/10 rounded-3xl p-8 hover:border-amber-vial/50 transition-all duration-300 flex flex-col">
                            ...
                            <div className="mt-8 pt-6 border-t border-white/10">
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    ...
                                    <a href="https://wa.me/56984534364" target="_blank">
                                        <TechButton variant="outline" className="w-full justify-center text-xs">
                ...
                <div className="text-center">
                    <p className="text-gray-500 text-sm">
                        * Si tienes dudas sobre qué opción elegir, contáctanos al <span className="text-white font-bold">+56 9 8453 4364</span>
                    </p>
                </div>
            </div>

            {/* Support Modal */}
            <Modal isOpen={isSupportModalOpen} onClose={() => setIsSupportModalOpen(false)} title="Soporte Académico">
                <div className="p-2">
