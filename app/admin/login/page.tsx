        ...
        <div className="min-h-screen bg-gray-50 flex flex-col md:flex-row">
            ...
            <div className="hidden md:flex flex-1 bg-navy-deep relative overflow-hidden flex-col justify-between p-12">
                ...
                <div className="relative z-10">
                    <BrandLogo variant="white" className="w-48 h-auto" />
                </div>

                <div className="relative z-10 max-w-md">
                    <div className="w-12 h-12 bg-white/10 rounded-xl flex items-center justify-center mb-6 border border-white/20 shadow-md">
                    ...
                    <p className="text-white/70 text-lg leading-relaxed">
                        Acceso exclusivo para personal autorizado de Posiciona.org. Administre prospectos, cierre negocios y visualice métricas en tiempo real.
                    </p>
                </div>
